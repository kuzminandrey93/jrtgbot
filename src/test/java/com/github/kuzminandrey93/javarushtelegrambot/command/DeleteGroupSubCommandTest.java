...
import static com.github.kuzminandrey93.javarushtelegrambot.command.CommandName.DELETE_GROUP_SUB;
...
public class DeleteGroupSubCommandTest {
    ...
    public void shouldProperlyReturnEmptySubscriptionList() {
        ...
        Mockito.when(telegramUserService.findByChatId(valueOf(chatId)))
        ...
        //then
        Mockito.verify(sendBotMessageService).sendMessage(valueOf(chatId), expectedMessage);
    }
    ...
    public void shouldProperlyDeleteByGroupId() {
        ...
        gs1.setTitle("GS1 Title");
        TelegramUser telegramUser = new TelegramUser();
        telegramUser.setChatId(valueOf(chatId));
        telegramUser.setGroupSubs(singletonList(gs1));
